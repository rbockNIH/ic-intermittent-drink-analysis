...
These template files are located in the `program files` folder and have been created with the proprietary software Designer that comes with the [IntelliCage](https://www.tse-systems.com/products/intellicage/) system. These files are only useful, if you have access to an IntelliCage system and its software package. They have been designed with the version 3.6.9.0 of the mentioned programs.
...
![Corner occupancy heatmap](IC%20Template%20Project/figures/C1/c1-qc-corner-occupancy-heatmap.png)
